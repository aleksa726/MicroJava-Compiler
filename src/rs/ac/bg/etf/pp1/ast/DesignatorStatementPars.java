...
public class DesignatorStatementPars extends DesignatorStatement {

    private MethodCallDesignator MethodCallDesignator;
    private ActParsList ActParsList;

    public DesignatorStatementPars (MethodCallDesignator MethodCallDesignator, ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementPars(\n");
